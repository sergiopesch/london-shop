...
export default function UndergroundMugPage() {
  // Get product data
  const productInfo = useMemo(() => getProduct("mugs", "mug-2"), [])
  ...
  const productInfoComponent = useMemo(
    () => (
      <ProductInfo
        ...
        colors={["White"]} // Underground mug only in white
        selectedColor={selectedColor}
    ...
    () => (
      <div className="backdrop-blur-sm bg-black/30 rounded-xl p-8 shadow-xl border border-white/10 mb-12">
        ...
        <p className="text-gray-200 mb-4">
          Our Underground mug features a clean, modern interpretation of London's most iconic symbol.
        </p>
        <p className="text-gray-200">
          Crafted from high-quality ceramic, this mug is both a practical everyday item and a stylish nod to London's
          design heritage.
        </p>
      </div>
    ),
