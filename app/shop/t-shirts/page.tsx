...
import { Leaf, Palette, Ruler } from "lucide-react"
        ...
        <div className="relative z-10 pt-28 px-4 md:px-8 pb-12">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16 animate-fade-in">
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">London T-Shirts</h1>
              <p className="text-xl text-white/80 max-w-2xl mx-auto">
                Premium t-shirts featuring iconic London-inspired designs
              </p>
            </div>
              ...
              {products.map((product, index) => (
                ...
                >
                  <ProductCard
                    ...
                    href={`/shop/t-shirts/${product.slug}`}
                  />
                </div>
              ))}
            </div>

            {/* T-Shirt Description - Simplified */}
            <div
              className="mt-16 backdrop-blur-sm bg-black/30 rounded-xl p-8 shadow-xl border border-white/10 animate-fade-in"
              style={{ animationDelay: "0.5s" }}
            >
              <h2 className="text-2xl font-bold text-white mb-6">About Our T-Shirts</h2>
              <p className="text-gray-200 mb-8">
                Our London-inspired t-shirts blend style with comfort. Made from 100% organic cotton, they feature our
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-black/20 p-6 rounded-lg group hover:bg-black/30 transition-colors">
                  <div className="w-16 h-16 rounded-full bg-red-600/20 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                    <Leaf className="text-red-500 w-8 h-8" />
                  </div>
                  <h3 className="text-white font-bold mb-2 text-center">Premium Quality</h3>
                  <p className="text-gray-300 text-sm text-center">
                    100% organic cotton for comfort and sustainability
                  </p>
                </div>
