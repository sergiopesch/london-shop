...
export default function UndergroundTShirtPage() {
  // Get product data
  const productInfo = useMemo(() => getProduct("t-shirts", "tshirt-2"), [])
  ...
  // Define color images mapping - Underground t-shirt only in white
    ...
    () => (
      <div className="backdrop-blur-sm bg-black/30 rounded-xl p-8 shadow-xl border border-white/10 mb-12">
        ...
        <p className="text-gray-200 mb-4">
          Our Underground t-shirt features a clean, modern take on London's most recognizable symbol.
        </p>
        <p className="text-gray-200">
          Made from 100% organic cotton, this t-shirt combines iconic design with sustainable comfort.
        </p>
      </div>
    ),
    [],
